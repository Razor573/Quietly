...
abstract class RepositoryModule {
    @Binds @Singleton abstract fun bindUsageRepo(impl: UsageRepositoryImpl): UsageRepository
    @Binds @Singleton abstract fun bindGoalRepo(impl: GoalRepositoryImpl):   GoalRepository
}
